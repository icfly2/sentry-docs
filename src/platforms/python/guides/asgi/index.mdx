...
sentry_sdk.init(dsn="___PUBLIC_DSN___") #don't forget to adjust the traces_sample_rate parameter in production

asgi_app = SentryAsgiMiddleware(asgi_app) # For FastAPI use the method below

# For FastAPI or other starlet based apps do this instead:
